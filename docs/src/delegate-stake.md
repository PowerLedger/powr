...
Note: As of the time of writing, native staking is not accessible to the general public, and staking through the [staking portal](https://stake.powerledger.io)
...
then next valid block of transactions in the blockchain. New POWR is then created 
periodically to reward stakers and validators. You earn more rewards
