...
Developers can write and deploy their own programs to the Powerledger blockchain.
...
On-chain programs are compiled via the [LLVM compiler
...
Because SVM blockchains like the Powerledger blockchain use the LLVM compiler infrastructure, 
a program may be written in any programming language that can target the LLVM's BPF backend. 
The Powerledger blockchain supports writing programs in Rust and C/C++.
...
The virtual address memory map used by Powerledger BPF programs is fixed and laid out
as follows
...
The Powerledger Program Library math tests will report the performance of some math
operations:
https://github.com/PowerLedger/powr-program-library/tree/main/libraries/math
...
[`Write`](https://github.com/PowerLedger/powr/blob/629c560537594a501a34d3b5235116ac8cca546e/sdk/program/src/loader_instruction.rs#L13)
...
[`Finalize`](https://github.com/PowerLedger/powr/blob/629c560537594a501a34d3b5235116ac8cca546e/sdk/program/src/loader_instruction.rs#L30)
