...
this step, you should see the “validator-stake-keypair.json” in your 
runtime directory.
...
Now delegate 1 POWR to your validator by first creating your stake account:
...
> Don’t delegate your remaining POWR, as your validator will use those tokens to vote.
...
- Powerledger blockchain nodes offer a number of useful JSON-RPC methods to return information about the network and your validator's participation. Make a request by using curl \(or another http client of your choosing\), specifying the desired method in JSON-RPC-formatted data. For example:
...
- `getVoteAccounts` This will tell you how much active stake your validator currently has. A % of the validator's stake is activated on an epoch boundary. You can learn more about staking [here](../cluster/stake-delegation-and-rewards.md).
